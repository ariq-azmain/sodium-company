   ...
   return (
      <header className="relative">
         <nav className="flex justify-between items-center !p-4">
            ...
            {isLoggedIn && (
               <div className="flex-1 font-black text-3xl ml-[15px]">
                  <span className="bg-gradient-to-b from-violet-900 to-indigo-600 px-4 py-2.5 rounded-full">
                     <span
                        className="bg-gradient-to-bl from-[#776ef7] to-[#73f0f7]
                  bg-clip-text
                  text-transparent"
                     >
